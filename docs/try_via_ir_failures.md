...
| [x] | `tpch/results/q20.slt` | line 19 | unsupported `LeftMark` join | `optd/connectors/datafusion/src/to_df.rs` |
| [x] | `tpch/results/q21.slt` | line 19 | unsupported `LeftMark` join | `optd/connectors/datafusion/src/to_df.rs` |
...
- [x] `optd/connectors/datafusion/tests/slt/features/correlated_subquery.slt:15`
...
- [x] `optd/connectors/datafusion/tests/slt/tpch/results/q2.slt:19`
...
- [x] `optd/connectors/datafusion/tests/slt/tpch/results/q4.slt:19`
  - Query shape: correlated `EXISTS` over `lineitem`
  - Missing field: `orders.o_orderkey`
  - Valid schema: `lineitem.*`
  - Fixed by exporting correlated optd `LeftSemi` joins as DataFusion
    `EXISTS` filters with explicit outer-reference metadata.
- [x] `optd/connectors/datafusion/tests/slt/tpch/results/q17.slt:19`
  ...
  - Fixed by reconstructing `Selection(SingleJoin)` predicates as DataFusion
    scalar subquery expressions with explicit outer-reference metadata.
- [x] `optd/connectors/datafusion/tests/slt/tpch/results/q22.slt:19`
...
`optd/connectors/datafusion/src/to_df.rs` does not convert that optd join type
...
- [x] `optd/connectors/datafusion/tests/slt/tpch/results/q20.slt:19`
...
- [x] `optd/connectors/datafusion/tests/slt/tpch/results/q21.slt:19`
...
`optd/connectors/datafusion/src/to_df.rs`.
...
- [x] `optd/connectors/datafusion/tests/slt/features/explain_udfs.slt:109`
