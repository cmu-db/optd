...
pub(super) struct Task {
    ...
    pub uncompleted_jobs: HashSet<i64>, // TODO: Replace with JobId
}
...
struct ForkLogicalTask {
    ...
    pub explore_group_in: TaskId,
    // old: pub fork_in: HashSet<TaskId>
    pub continue_tasks: HashSet<TaskId>,
}
