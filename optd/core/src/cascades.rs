...
use crate::{
    ...
    rules::{EnforceTupleOrderingRule, JoinOrderingPass, SimplificationPass, UnnestingRule},
};
...
impl Cascades {
    ...
    pub async fn optimize(
        ...
        let join_ordered = JoinOrderingPass::new().apply(simplified, &self.ctx)?;
        let group_id = self.insert_new_operator(&join_ordered).await;
