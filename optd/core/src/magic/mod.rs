            ...
            TableStatistics {
                ...
                column_statistics: vec![
                    ...
                    ColumnStatistics {
                        ...
                        advanced_stats: vec![],
                        min_value: Some(json!(3)),
                        max_value: Some(json!(15)),
                        null_count: Some(0),
