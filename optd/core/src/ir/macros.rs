...
macro_rules! generate_metadata_getters {
    ($node_type:ident, $($field:ident: $field_type:ty),*) => {
        impl $node_type {
            $(
...
macro_rules! generate_common_node {
    ($node_name:ident, $props_type:ty, $metadata_type:ident, $($field_name:ident: $field_type:ty),*) => {
...
macro_rules! define_node {
    (
        ...
        crate::ir::macros::generate_common_node!($node_name, $props_type, $metadata_type, $($field_name: $field_type),*);
        crate::ir::macros::generate_metadata_getters!($node_name, $($field_name: $field_type),*);
        crate::ir::macros::generate_operator_input_getters!($node_name, [$($op_input),*]);
        crate::ir::macros::generate_scalar_input_getters!($node_name, [$($scalar_input),*]);
    };
    ...
    (
        ...
        crate::ir::macros::generate_common_node!($node_name, $props_type, $metadata_type, $($field_name: $field_type),*);
        crate::ir::macros::generate_metadata_getters!($node_name, $($field_name: $field_type),*);
        crate::ir::macros::generate_operator_input_getters!($node_name, $op_inputs[]);
        crate::ir::macros::generate_scalar_input_getters!($node_name, [$($scalar_input),*]);
    };
    ...
    (
        ...
        crate::ir::macros::generate_metadata_getters!($node_name, $($field_name: $field_type),*);
        crate::ir::macros::generate_operator_input_getters!($node_name, [$($op_input),*]);
        crate::ir::macros::generate_scalar_input_getters!($node_name, $scalar_inputs[]);
    };
