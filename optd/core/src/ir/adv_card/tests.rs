...
// };
// use crate::magic::{MemoryCatalog, MagicCostModel};

// use super::AdvancedCardinalityEstimator;

// /// Create an IRContext using MemoryCatalog with AdvancedCardinalityEstimator.
...
// fn cascades_with_catalog(cat: MemoryCatalog) -> Arc<Cascades> {
//     let ctx = adv_ctx_with_catalog(cat);
