...
Project
├── .table_index: 3
├── .projections: [ __internal_#2.count(numbers.id)(#2.0), __internal_#2.sum(numbers.val)(#2.1), __internal_#2.min(numbers.val)(#2.2), __internal_#2.max(numbers.val)(#2.3) ]
...
└── Aggregate
    ...
    ├── .keys: []
    ├── (.output_columns): __internal_#2.count(numbers.id)(#2.0), __internal_#2.max(numbers.val)(#2.3), __internal_#2.min(numbers.val)(#2.2), __internal_#2.sum(numbers.val)(#2.1)
    ├── (.cardinality): 1.00
    └── Get
        ├── .data_source_id: 1
        ├── .table_index: 1
...
logical_plan after optd-initial:
OrderBy
├── ordering_exprs: [ __internal_#3.grp(#3.0) ASC ]
├── (.output_columns): __internal_#3.count(numbers.id)(#3.1), __internal_#3.grp(#3.0), __internal_#3.sum(numbers.val + numbers.bonus)(#3.2)
├── (.cardinality): 1.00
└── Project
    ├── .table_index: 3
    ├── .projections: [ numbers.grp(#1.1), __internal_#2.count(numbers.id)(#2.0), __internal_#2.sum(numbers.val + numbers.bonus)(#2.1) ]
    ├── (.output_columns): __internal_#3.count(numbers.id)(#3.1), __internal_#3.grp(#3.0), __internal_#3.sum(numbers.val + numbers.bonus)(#3.2)
    ├── (.cardinality): 1.00
    └── Aggregate
        ├── .aggregate_table_index: 2
        ...
        ├── (.output_columns): __internal_#2.count(numbers.id)(#2.0), __internal_#2.sum(numbers.val + numbers.bonus)(#2.1), numbers.grp(#1.1)
        ├── (.cardinality): 1.00
        └── Get
            ├── .data_source_id: 1
            ├── .table_index: 1
...
logical_plan after optd-initial:
OrderBy
├── ordering_exprs: [ __internal_#3.grp(#3.0) ASC, __internal_#3.bonus(#3.1) ASC ]
├── (.output_columns): __internal_#3.bonus(#3.1), __internal_#3.count(numbers.id)(#3.2), __internal_#3.grp(#3.0)
├── (.cardinality): 0.20
└── Project
    ├── .table_index: 3
    ├── .projections: [ numbers.grp(#1.1), numbers.bonus(#1.3), __internal_#2.count(numbers.id)(#2.0) ]
    ├── (.output_columns): __internal_#3.bonus(#3.1), __internal_#3.count(numbers.id)(#3.2), __internal_#3.grp(#3.0)
    ├── (.cardinality): 0.20
    └── Aggregate
        ├── .aggregate_table_index: 2
        ...
        ├── (.output_columns): __internal_#2.count(numbers.id)(#2.0), numbers.bonus(#1.3), numbers.grp(#1.1)
        ├── (.cardinality): 0.20
        └── Get
            ├── .data_source_id: 1
            ├── .table_index: 1
...
physical_plan after optd-finalized:
EnforcerSort
├── tuple_ordering: [(#3.0, Asc), (#3.1, Asc)]
├── (.output_columns): __internal_#3.bonus(#3.1), __internal_#3.count(numbers.id)(#3.2), __internal_#3.grp(#3.0)
├── (.cardinality): 0.20
└── Project
    ├── .table_index: 3
...
logical_plan after optd-initial:
OrderBy
├── ordering_exprs: [ __internal_#6.category(#6.0) ASC ]
├── (.output_columns): __internal_#6.category(#6.0), __internal_#6.count(n.id)(#6.1), __internal_#6.sum(n.val)(#6.2)
├── (.cardinality): 2.00
└── Project
    ├── .table_index: 6
    ├── .projections: [ d.category(#4.1), __internal_#5.count(n.id)(#5.0), __internal_#5.sum(n.val)(#5.1) ]
    ├── (.output_columns): __internal_#6.category(#6.0), __internal_#6.count(n.id)(#6.1), __internal_#6.sum(n.val)(#6.2)
    ├── (.cardinality): 2.00
    └── Aggregate
        ...
        ├── .keys: [ d.category(#4.1) ]
        ├── (.output_columns): __internal_#5.count(n.id)(#5.0), __internal_#5.sum(n.val)(#5.1), d.category(#4.1)
        ├── (.cardinality): 2.00
        └── Join
            ├── .join_type: Inner
            ├── .implementation: None
...
OrderBy
├── ordering_exprs: [ __internal_#3.grp(#3.0) ASC ]
├── (.output_columns): __internal_#3.grp(#3.0), __internal_#3.total(#3.1)
├── (.cardinality): 0.10
└── Project
    ├── .table_index: 3
    ├── .projections: [ numbers.grp(#1.1), __internal_#2.sum(numbers.val)(#2.0) ]
    ├── (.output_columns): __internal_#3.grp(#3.0), __internal_#3.total(#3.1)
    ├── (.cardinality): 0.10
    └── Select
        ├── .predicate: __internal_#2.sum(numbers.val)(#2.0) > 20::bigint
        ├── (.output_columns): __internal_#2.sum(numbers.val)(#2.0), numbers.grp(#1.1)
        ├── (.cardinality): 0.10
        └── Aggregate
            ├── .aggregate_table_index: 2
            ├── .implementation: None
...
├── (.cardinality): 1.00
└── OrderBy
    ├── ordering_exprs: [ __internal_#3.total(#3.1) DESC ]
    ├── (.output_columns): __internal_#3.grp(#3.0), __internal_#3.total(#3.1)
    ├── (.cardinality): 1.00
    └── Project
        ├── .table_index: 3
