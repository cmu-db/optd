...
Limit { .skip: 0::bigint, .fetch: 3::bigint, (.output_columns): __internal_#4.avg_disc(#4.8), __internal_#4.avg_price(#4.7), __internal_#4.avg_qty(#4.6), __internal_#4.count_order(#4.9), __internal_#4.l_linestatus(#4.1), __internal_#4.l_returnflag(#4.0), __internal_#4.sum_base_price(#4.3), __internal_#4.sum_charge(#4.5), __internal_#4.sum_disc_price(#4.4), __internal_#4.sum_qty(#4.2), (.cardinality): 0.00 }
└── OrderBy { ordering_exprs: [ __internal_#4.l_returnflag(#4.0) ASC, __internal_#4.l_linestatus(#4.1) ASC ], (.output_columns): __internal_#4.avg_disc(#4.8), __internal_#4.avg_price(#4.7), __internal_#4.avg_qty(#4.6), __internal_#4.count_order(#4.9), __internal_#4.l_linestatus(#4.1), __internal_#4.l_returnflag(#4.0), __internal_#4.sum_base_price(#4.3), __internal_#4.sum_charge(#4.5), __internal_#4.sum_disc_price(#4.4), __internal_#4.sum_qty(#4.2), (.cardinality): 0.00 }
    └── Project
        ├── .table_index: 4
...
Limit { .skip: 0::bigint, .fetch: 3::bigint, (.output_columns): __internal_#4.avg_disc(#4.8), __internal_#4.avg_price(#4.7), __internal_#4.avg_qty(#4.6), __internal_#4.count_order(#4.9), __internal_#4.l_linestatus(#4.1), __internal_#4.l_returnflag(#4.0), __internal_#4.sum_base_price(#4.3), __internal_#4.sum_charge(#4.5), __internal_#4.sum_disc_price(#4.4), __internal_#4.sum_qty(#4.2), (.cardinality): 0.00 }
└── EnforcerSort { tuple_ordering: [(#4.0, Asc), (#4.1, Asc)], (.output_columns): __internal_#4.avg_disc(#4.8), __internal_#4.avg_price(#4.7), __internal_#4.avg_qty(#4.6), __internal_#4.count_order(#4.9), __internal_#4.l_linestatus(#4.1), __internal_#4.l_returnflag(#4.0), __internal_#4.sum_base_price(#4.3), __internal_#4.sum_charge(#4.5), __internal_#4.sum_disc_price(#4.4), __internal_#4.sum_qty(#4.2), (.cardinality): 0.00 }
    └── Project
        ├── .table_index: 4
        ├── .projections: [ __internal_#2.l_returnflag(#2.9), __internal_#2.l_linestatus(#2.10), __internal_#3.sum(lineitem.l_quantity)(#3.0), __internal_#3.sum(lineitem.l_extendedprice)(#3.1), __internal_#3.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#3.2), __internal_#3.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount * Int64(1) + lineitem.l_tax)(#3.3), __internal_#3.avg(lineitem.l_quantity)(#3.4), __internal_#3.avg(lineitem.l_extendedprice)(#3.5), __internal_#3.avg(lineitem.l_discount)(#3.6), __internal_#3.count(Int64(1))(#3.7) ]
        ├── (.output_columns): __internal_#4.avg_disc(#4.8), __internal_#4.avg_price(#4.7), __internal_#4.avg_qty(#4.6), __internal_#4.count_order(#4.9), __internal_#4.l_linestatus(#4.1), __internal_#4.l_returnflag(#4.0), __internal_#4.sum_base_price(#4.3), __internal_#4.sum_charge(#4.5), __internal_#4.sum_disc_price(#4.4), __internal_#4.sum_qty(#4.2)
