...
└── OrderBy { ordering_exprs: [ s_acctbal(#16.0) DESC, n_name(#16.2) ASC, s_name(#16.1) ASC, p_partkey(#16.3) ASC ], (.output_columns): n_name(#16.2), p_mfgr(#16.4), p_partkey(#16.3), s_acctbal(#16.0), s_address(#16.5), s_comment(#16.7), s_name(#16.1), s_phone(#16.6), (.cardinality): 0.00 }
        ...
        └── Project
            ...
            └── Project
                ...
                └── Join
                    ...
                    └── Remap { .table_index: 13, (.output_columns): __always_true(#13.2), min(partsupp.ps_supplycost)(#13.0), ps_partkey(#13.1), (.cardinality): 0.00 }
                        └── Project { .table_index: 12, .projections: [ min(partsupp.ps_supplycost)(#11.2), ps_partkey(#2.0), __always_true(#11.1) ], (.output_columns): __always_true(#12.2), min(partsupp.ps_supplycost)(#12.0), ps_partkey(#12.1), (.cardinality): 0.00 }
                            └── Project { .table_index: 11, .projections: [ ps_partkey(#6.0), true::boolean, min(partsupp.ps_supplycost)(#10.0) ], (.output_columns): __always_true(#11.1), min(partsupp.ps_supplycost)(#11.2), ps_partkey(#11.0), (.cardinality): 0.00 }
                                └── Aggregate { .aggregate_table_index: 10, .implementation: None, .exprs: min(ps_supplycost(#6.3)), .keys: [ ps_partkey(#6.0) ], (.output_columns): min(partsupp.ps_supplycost)(#10.0), ps_partkey(#6.0), (.cardinality): 0.00 }
...
└── EnforcerSort { tuple_ordering: [(#16.0, Desc), (#16.2, Asc), (#16.1, Asc), (#16.3, Asc)], (.output_columns): n_name(#16.2), p_mfgr(#16.4), p_partkey(#16.3), s_acctbal(#16.0), s_address(#16.5), s_comment(#16.7), s_name(#16.1), s_phone(#16.6), (.cardinality): 0.00 }
    └── Project { .table_index: 16, .projections: [ s_acctbal(#3.5), s_name(#3.1), n_name(#4.1), p_partkey(#1.0), p_mfgr(#1.2), s_address(#3.2), s_phone(#3.4), s_comment(#3.6) ], (.output_columns): n_name(#16.2), p_mfgr(#16.4), p_partkey(#16.3), s_acctbal(#16.0), s_address(#16.5), s_comment(#16.7), s_name(#16.1), s_phone(#16.6), (.cardinality): 0.00 }
        └── Join
            ├── .join_type: Inner
            ├── .implementation: None
            ├── .join_cond: (p_partkey(#1.0) = ps_partkey(#13.1)) AND (ps_supplycost(#2.3) = min(partsupp.ps_supplycost)(#13.0))
            ├── (.output_columns): __always_true(#13.2), min(partsupp.ps_supplycost)(#13.0), n_name(#4.1), n_nationkey(#4.0), n_regionkey(#4.2), p_mfgr(#1.2), p_partkey(#1.0), p_size(#1.5), p_type(#1.4), ps_partkey(#13.1), ps_partkey(#2.0), ps_suppkey(#2.1), ps_supplycost(#2.3), r_name(#5.1), r_regionkey(#5.0), s_acctbal(#3.5), s_address(#3.2), s_comment(#3.6), s_name(#3.1), s_nationkey(#3.3), s_phone(#3.4), s_suppkey(#3.0)
            ├── (.cardinality): 0.00
            ├── Join
            │   ├── .join_type: Inner
            │   ├── .implementation: None
            ...
            └── Remap { .table_index: 13, (.output_columns): __always_true(#13.2), min(partsupp.ps_supplycost)(#13.0), ps_partkey(#13.1), (.cardinality): 0.00 }
                └── Project { .table_index: 12, .projections: [ min(partsupp.ps_supplycost)(#10.0), ps_partkey(#2.0), true::boolean ], (.output_columns): __always_true(#12.2), min(partsupp.ps_supplycost)(#12.0), ps_partkey(#12.1), (.cardinality): 0.00 }
                    └── Aggregate { .aggregate_table_index: 10, .implementation: None, .exprs: [ min(ps_supplycost(#6.3)) ], .keys: [ ps_partkey(#6.0) ], (.output_columns): min(partsupp.ps_supplycost)(#10.0), ps_partkey(#6.0), (.cardinality): 0.00 }
