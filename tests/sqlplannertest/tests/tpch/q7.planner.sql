            ...
            └── Project
                ...
                └── Select
                    ...
                    └── Join
                        ...
                        │   │   ├── .join_type: Inner
                        │   │   ├── .implementation: None
                        │   │   ├── .join_cond: ("orders.o_custkey"(#3.1) = "customer.c_custkey"(#4.0))
                        │   │   ├── (.output_columns):
                        │   │   │   ┌── "customer.c_acctbal"(#4.5)
                        │   │   │   ├── "customer.c_address"(#4.2)
                        │   │   │   ├── "customer.c_comment"(#4.7)
                        ...
                        │   │   │   ├── .join_type: Inner
                        │   │   │   ├── .implementation: None
                        │   │   │   ├── .join_cond: ("lineitem.l_orderkey"(#2.0) = "orders.o_orderkey"(#3.0))
                        │   │   │   ├── (.output_columns):
                        │   │   │   │   ┌── "lineitem.l_comment"(#2.15)
                        │   │   │   │   ├── "lineitem.l_commitdate"(#2.11)
                        │   │   │   │   ├── "lineitem.l_discount"(#2.6)
                        ...
                        │   │   │       ├── .table_index: 3
                        │   │   │       ├── .implementation: None
                        │   │   │       ├── (.output_columns): [ "orders.o_clerk"(#3.6), "orders.o_comment"(#3.8), "orders.o_custkey"(#3.1), "orders.o_orderdate"(#3.4), "orders.o_orderkey"(#3.0), "orders.o_orderpriority"(#3.5), "orders.o_orderstatus"(#3.2), "orders.o_shippriority"(#3.7), "orders.o_totalprice"(#3.3) ]
                        │   │   │       └── (.cardinality): 0.00
                        │   │   └── Get
                        │   │       ├── .data_source_id: 6
                        │   │       ├── .table_index: 4
                        │   │       ├── .implementation: None
                        │   │       ├── (.output_columns): [ "customer.c_acctbal"(#4.5), "customer.c_address"(#4.2), "customer.c_comment"(#4.7), "customer.c_custkey"(#4.0), "customer.c_mktsegment"(#4.6), "customer.c_name"(#4.1), "customer.c_nationkey"(#4.3), "customer.c_phone"(#4.4) ]
                        │   │       └── (.cardinality): 0.00
