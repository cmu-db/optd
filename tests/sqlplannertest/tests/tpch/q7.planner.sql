...
OrderBy { ordering_exprs: [ "__#13.supp_nation"(#13.0) ASC, "__#13.cust_nation"(#13.1) ASC, "__#13.l_year"(#13.2) ASC ], (.output_columns): [ "__#13.cust_nation"(#13.1), "__#13.l_year"(#13.2), "__#13.revenue"(#13.3), "__#13.supp_nation"(#13.0) ], (.cardinality): 0.00 }
└── Project { .table_index: 13, .projections: [ "shipping.supp_nation"(#10.0), "shipping.cust_nation"(#10.1), "shipping.l_year"(#10.2), "__#12.sum(shipping.volume)"(#12.0) ], (.output_columns): [ "__#13.cust_nation"(#13.1), "__#13.l_year"(#13.2), "__#13.revenue"(#13.3), "__#13.supp_nation"(#13.0) ], (.cardinality): 0.00 }
    └── Aggregate { .key_table_index: 11, .aggregate_table_index: 12, .implementation: None, .exprs: sum("shipping.volume"(#10.3)), .keys: [ "shipping.supp_nation"(#10.0), "shipping.cust_nation"(#10.1), "shipping.l_year"(#10.2) ], (.output_columns): [ "__#11.cust_nation"(#11.1), "__#11.l_year"(#11.2), "__#11.supp_nation"(#11.0), "__#12.sum(shipping.volume)"(#12.0) ], (.cardinality): 0.00 }
        └── Remap { .table_index: 10, (.output_columns): [ "shipping.cust_nation"(#10.1), "shipping.l_year"(#10.2), "shipping.supp_nation"(#10.0), "shipping.volume"(#10.3) ], (.cardinality): 0.00 }
            └── Project { .table_index: 9, .projections: [ "n1.n_name"(#6.1), "n2.n_name"(#8.1), date_part('YEAR'::utf8, "lineitem.l_shipdate"(#2.10)), "lineitem.l_extendedprice"(#2.5) * CAST (1::bigint AS Decimal128(20, 0)) - "lineitem.l_discount"(#2.6) ], (.output_columns): [ "__#9.cust_nation"(#9.1), "__#9.l_year"(#9.2), "__#9.supp_nation"(#9.0), "__#9.volume"(#9.3) ], (.cardinality): 0.00 }
                └── Select
                    ├── .predicate: ("supplier.s_suppkey"(#1.0) = "lineitem.l_suppkey"(#2.2)) AND ("orders.o_orderkey"(#3.0) = "lineitem.l_orderkey"(#2.0)) AND ("customer.c_custkey"(#4.0) = "orders.o_custkey"(#3.1)) AND ("supplier.s_nationkey"(#1.3) = "n1.n_nationkey"(#6.0)) AND ("customer.c_nationkey"(#4.3) = "n2.n_nationkey"(#8.0)) AND ((("n1.n_name"(#6.1) = CAST ('FRANCE'::utf8 AS Utf8View)) AND ("n2.n_name"(#8.1) = CAST ('GERMANY'::utf8 AS Utf8View))) OR (("n1.n_name"(#6.1) = CAST ('GERMANY'::utf8 AS Utf8View)) AND ("n2.n_name"(#8.1) = CAST ('FRANCE'::utf8 AS Utf8View)))) AND (("lineitem.l_shipdate"(#2.10) >= CAST ('1995-01-01'::utf8 AS Date32)) AND ("lineitem.l_shipdate"(#2.10) <= CAST ('1996-12-31'::utf8 AS Date32)))
                    ├── (.output_columns):
                    │   ┌── "customer.c_acctbal"(#4.5)
                    │   ├── "customer.c_address"(#4.2)
                    │   ├── "customer.c_comment"(#4.7)
                    │   ├── "customer.c_custkey"(#4.0)
                    │   ├── "customer.c_mktsegment"(#4.6)
                    │   ├── "customer.c_name"(#4.1)
                    │   ├── "customer.c_nationkey"(#4.3)
                    │   ├── "customer.c_phone"(#4.4)
                    ...
                    │   ├── "n2.n_regionkey"(#8.2)
                    │   ├── "orders.o_clerk"(#3.6)
                    │   ├── "orders.o_comment"(#3.8)
                    │   ├── "orders.o_custkey"(#3.1)
                    │   ├── "orders.o_orderdate"(#3.4)
                    │   ├── "orders.o_orderkey"(#3.0)
                    │   ├── "orders.o_orderpriority"(#3.5)
                    │   ├── "orders.o_orderstatus"(#3.2)
                    │   ├── "orders.o_shippriority"(#3.7)
                    │   ├── "orders.o_totalprice"(#3.3)
...
└── Project
    ├── .table_index: 13
    ├── .projections: [ "shipping.supp_nation"(#10.0), "shipping.cust_nation"(#10.1), "shipping.l_year"(#10.2), "__#12.sum(shipping.volume)"(#12.0) ]
    ├── (.output_columns): [ "__#13.cust_nation"(#13.1), "__#13.l_year"(#13.2), "__#13.revenue"(#13.3), "__#13.supp_nation"(#13.0) ]
    ├── (.cardinality): 0.00
    └── Aggregate
        ├── .key_table_index: 11
        ├── .aggregate_table_index: 12
        ├── .implementation: None
        ├── .exprs: sum("shipping.volume"(#10.3))
        ├── .keys: [ "shipping.supp_nation"(#10.0), "shipping.cust_nation"(#10.1), "shipping.l_year"(#10.2) ]
        ├── (.output_columns): [ "__#11.cust_nation"(#11.1), "__#11.l_year"(#11.2), "__#11.supp_nation"(#11.0), "__#12.sum(shipping.volume)"(#12.0) ]
        ├── (.cardinality): 0.00
        └── Remap { .table_index: 10, (.output_columns): [ "shipping.cust_nation"(#10.1), "shipping.l_year"(#10.2), "shipping.supp_nation"(#10.0), "shipping.volume"(#10.3) ], (.cardinality): 0.00 }
            └── Project
                ├── .table_index: 9
                ├── .projections: [ "n1.n_name"(#6.1), "n2.n_name"(#8.1), date_part('YEAR'::utf8, "lineitem.l_shipdate"(#2.10)), "lineitem.l_extendedprice"(#2.5) * 1::decimal128(20, 0) - "lineitem.l_discount"(#2.6) ]
                ...
                └── Join
                    ...
                    │   │   ├── .join_type: Inner
                    │   │   ├── .implementation: None
                    │   │   ├── .join_cond: "customer.c_custkey"(#4.0) = "orders.o_custkey"(#3.1)
                    │   │   ├── (.output_columns):
                    │   │   │   ┌── "customer.c_custkey"(#4.0)
                    │   │   │   ├── "customer.c_nationkey"(#4.3)
                    │   │   │   ├── "lineitem.l_discount"(#2.6)
                    ...
                    │   │   │   ├── .join_type: Inner
                    │   │   │   ├── .implementation: None
                    │   │   │   ├── .join_cond: "orders.o_orderkey"(#3.0) = "lineitem.l_orderkey"(#2.0)
                    │   │   │   ├── (.output_columns):
                    │   │   │   │   ┌── "lineitem.l_discount"(#2.6)
                    │   │   │   │   ├── "lineitem.l_extendedprice"(#2.5)
                    │   │   │   │   ├── "lineitem.l_orderkey"(#2.0)
                    ...
                    │   │   │   │   ├── .join_type: Inner
                    │   │   │   │   ├── .implementation: None
                    │   │   │   │   ├── .join_cond: "supplier.s_suppkey"(#1.0) = "lineitem.l_suppkey"(#2.2)
                    │   │   │   │   ├── (.output_columns): [ "lineitem.l_discount"(#2.6), "lineitem.l_extendedprice"(#2.5), "lineitem.l_orderkey"(#2.0), "lineitem.l_shipdate"(#2.10), "lineitem.l_suppkey"(#2.2), "supplier.s_nationkey"(#1.3), "supplier.s_suppkey"(#1.0) ]
                    │   │   │   │   ├── (.cardinality): 0.00
                    ...
                    │   │   │   │   └── Select
                    │   │   │   │       ├── .predicate: ("lineitem.l_shipdate"(#2.10) >= 1995-01-01::date32) AND ("lineitem.l_shipdate"(#2.10) <= 1996-12-31::date32)
                    │   │   │   │       ├── (.output_columns): [ "lineitem.l_discount"(#2.6), "lineitem.l_extendedprice"(#2.5), "lineitem.l_orderkey"(#2.0), "lineitem.l_shipdate"(#2.10), "lineitem.l_suppkey"(#2.2) ]
                    │   │   │   │       ├── (.cardinality): 0.00
                    │   │   │   │       └── Get
                    │   │   │   │           ├── .data_source_id: 8
                    │   │   │   │           ├── .table_index: 2
