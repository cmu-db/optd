...
OrderBy { ordering_exprs: [ supp_nation(#12.0) ASC, cust_nation(#12.1) ASC, l_year(#12.2) ASC ], (.output_columns): cust_nation(#12.1), l_year(#12.2), revenue(#12.3), supp_nation(#12.0), (.cardinality): 0.01 }
└── Project { .table_index: 12, .projections: [ supp_nation(#10.0), cust_nation(#10.1), l_year(#10.2), sum(shipping.volume)(#11.0) ], (.output_columns): cust_nation(#12.1), l_year(#12.2), revenue(#12.3), supp_nation(#12.0), (.cardinality): 0.01 }
    └── Aggregate { .aggregate_table_index: 11, .implementation: None, .exprs: [ sum(volume(#10.3)) ], .keys: [ supp_nation(#10.0), cust_nation(#10.1), l_year(#10.2) ], (.output_columns): cust_nation(#10.1), l_year(#10.2), sum(shipping.volume)(#11.0), supp_nation(#10.0), (.cardinality): 0.01 }
...
EnforcerSort { tuple_ordering: [(#12.0, Asc), (#12.1, Asc), (#12.2, Asc)], (.output_columns): cust_nation(#12.1), l_year(#12.2), revenue(#12.3), supp_nation(#12.0), (.cardinality): 0.01 }
└── Project { .table_index: 12, .projections: [ supp_nation(#10.0), cust_nation(#10.1), l_year(#10.2), sum(shipping.volume)(#11.0) ], (.output_columns): cust_nation(#12.1), l_year(#12.2), revenue(#12.3), supp_nation(#12.0), (.cardinality): 0.01 }
    └── Aggregate { .aggregate_table_index: 11, .implementation: None, .exprs: [ sum(volume(#10.3)) ], .keys: [ supp_nation(#10.0), cust_nation(#10.1), l_year(#10.2) ], (.output_columns): cust_nation(#10.1), l_year(#10.2), sum(shipping.volume)(#11.0), supp_nation(#10.0), (.cardinality): 0.01 }
        └── Remap { .table_index: 10, (.output_columns): cust_nation(#10.1), l_year(#10.2), supp_nation(#10.0), volume(#10.3), (.cardinality): 0.00 }
            └── Project { .table_index: 9, .projections: [ n_name(#6.1), n_name(#8.1), date_part(YEAR::utf8, l_shipdate(#2.10)), l_extendedprice(#2.5) * 1::decimal128(20, 0) - l_discount(#2.6) ], (.output_columns): cust_nation(#9.1), l_year(#9.2), supp_nation(#9.0), volume(#9.3), (.cardinality): 0.00 }
