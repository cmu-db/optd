...
OrderBy { ordering_exprs: [ nation(#11.0) ASC, o_year(#11.1) DESC ], (.output_columns): nation(#11.0), o_year(#11.1), sum_profit(#11.2), (.cardinality): 0.04 }
└── Project { .table_index: 11, .projections: [ nation(#9.0), o_year(#9.1), sum(profit.amount)(#10.0) ], (.output_columns): nation(#11.0), o_year(#11.1), sum_profit(#11.2), (.cardinality): 0.04 }
    └── Aggregate { .aggregate_table_index: 10, .implementation: None, .exprs: [ sum(amount(#9.2)) ], .keys: [ nation(#9.0), o_year(#9.1) ], (.output_columns): nation(#9.0), o_year(#9.1), sum(profit.amount)(#10.0), (.cardinality): 0.04 }
...
EnforcerSort { tuple_ordering: [(#11.0, Asc), (#11.1, Desc)], (.output_columns): nation(#11.0), o_year(#11.1), sum_profit(#11.2), (.cardinality): 0.04 }
└── Project { .table_index: 11, .projections: [ nation(#9.0), o_year(#9.1), sum(profit.amount)(#10.0) ], (.output_columns): nation(#11.0), o_year(#11.1), sum_profit(#11.2), (.cardinality): 0.04 }
    └── Aggregate { .aggregate_table_index: 10, .implementation: None, .exprs: [ sum(amount(#9.2)) ], .keys: [ nation(#9.0), o_year(#9.1) ], (.output_columns): nation(#9.0), o_year(#9.1), sum(profit.amount)(#10.0), (.cardinality): 0.04 }
        └── Remap { .table_index: 9, (.output_columns): amount(#9.2), nation(#9.0), o_year(#9.1), (.cardinality): 0.00 }
            └── Project { .table_index: 8, .projections: [ n_name(#7.47), date_part(YEAR::utf8, o_orderdate(#7.41)), l_extendedprice(#7.21) * 1::decimal128(20, 0) - l_discount(#7.22) - ps_supplycost(#7.35) * l_quantity(#7.20) ], (.output_columns): amount(#8.2), nation(#8.0), o_year(#8.1), (.cardinality): 0.00 }
