    ...
    └── Aggregate
        ...
        └── Select
            ...
            └── Join
                ...
                │       ├── .table_index: 5
                │       ├── .implementation: None
                │       ├── (.output_columns): [ "nation.n_comment"(#5.3), "nation.n_name"(#5.1), "nation.n_nationkey"(#5.0), "nation.n_regionkey"(#5.2) ]
                │       └── (.cardinality): 0.00
                └── Get
                    ├── .data_source_id: 2
                    ├── .table_index: 6
                    ├── .implementation: None
                    ├── (.output_columns): [ "region.r_comment"(#6.2), "region.r_name"(#6.1), "region.r_regionkey"(#6.0) ]
                    └── (.cardinality): 0.00
