...
OrderBy { ordering_exprs: [ revenue(#8.1) DESC ], (.output_columns): nation(#8.0), revenue(#8.1), (.cardinality): 0.20 }
└── Project { .table_index: 8, .projections: [ n_name(#5.1), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#7.0) ], (.output_columns): nation(#8.0), revenue(#8.1), (.cardinality): 0.20 }
    └── Aggregate { .aggregate_table_index: 7, .implementation: None, .exprs: sum(l_extendedprice(#3.5) * 1::decimal128(20, 0) - l_discount(#3.6)), .keys: [ n_name(#5.1) ], (.output_columns): n_name(#5.1), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#7.0), (.cardinality): 0.20 }
        └── Join
            ├── .join_type: Inner
            ├── .implementation: None
...
EnforcerSort { tuple_ordering: [(#8.1, Desc)], (.output_columns): nation(#8.0), revenue(#8.1), (.cardinality): 0.20 }
└── Project { .table_index: 8, .projections: [ n_name(#5.1), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#7.0) ], (.output_columns): nation(#8.0), revenue(#8.1), (.cardinality): 0.20 }
    └── Aggregate { .aggregate_table_index: 7, .implementation: None, .exprs: sum(l_extendedprice(#3.5) * 1::decimal128(20, 0) - l_discount(#3.6)), .keys: [ n_name(#5.1) ], (.output_columns): n_name(#5.1), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#7.0), (.cardinality): 0.20 }
        └── Join
            ├── .join_type: Inner
