...
OrderBy { ordering_exprs: "__#9.revenue"(#9.1) DESC, (.output_columns): [ "__#9.nation"(#9.0), "__#9.revenue"(#9.1) ], (.cardinality): 0.00 }
└── Project { .table_index: 9, .projections: [ "nation.n_name"(#5.1), "__#8.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)"(#8.0) ], (.output_columns): [ "__#9.nation"(#9.0), "__#9.revenue"(#9.1) ], (.cardinality): 0.00 }
    └── Aggregate { .key_table_index: 7, .aggregate_table_index: 8, .implementation: None, .exprs: sum("lineitem.l_extendedprice"(#3.5) * CAST (1::bigint AS Decimal128(20, 0)) - "lineitem.l_discount"(#3.6)), .keys: "nation.n_name"(#5.1), (.output_columns): [ "__#7.n_name"(#7.0), "__#8.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)"(#8.0) ], (.cardinality): 0.00 }
        └── Select
            ├── .predicate: ("customer.c_custkey"(#1.0) = "orders.o_custkey"(#2.1)) AND ("lineitem.l_orderkey"(#3.0) = "orders.o_orderkey"(#2.0)) AND ("lineitem.l_suppkey"(#3.2) = "supplier.s_suppkey"(#4.0)) AND ("customer.c_nationkey"(#1.3) = "supplier.s_nationkey"(#4.3)) AND ("supplier.s_nationkey"(#4.3) = "nation.n_nationkey"(#5.0)) AND ("nation.n_regionkey"(#5.2) = "region.r_regionkey"(#6.0)) AND ("region.r_name"(#6.1) = CAST ('Asia'::utf8 AS Utf8View)) AND ("orders.o_orderdate"(#2.4) >= CAST ('2023-01-01'::utf8 AS Date32)) AND ("orders.o_orderdate"(#2.4) < CAST ('2024-01-01'::utf8 AS Date32))
            ├── (.output_columns):
            ...
            │   ├── "region.r_comment"(#6.2)
            │   ├── "region.r_name"(#6.1)
            │   ├── "region.r_regionkey"(#6.0)
            │   ├── "supplier.s_acctbal"(#4.5)
            │   ├── "supplier.s_address"(#4.2)
            │   ├── "supplier.s_comment"(#4.6)
            │   ├── "supplier.s_name"(#4.1)
            │   ├── "supplier.s_nationkey"(#4.3)
            │   ├── "supplier.s_phone"(#4.4)
            │   └── "supplier.s_suppkey"(#4.0)
            ├── (.cardinality): 0.00
            └── Join
                ├── .join_type: Inner
                ├── .implementation: None
                ...
                │   │   │       ├── .table_index: 3
                │   │   │       ├── .implementation: None
                │   │   │       ├── (.output_columns): [ "lineitem.l_comment"(#3.15), "lineitem.l_commitdate"(#3.11), "lineitem.l_discount"(#3.6), "lineitem.l_extendedprice"(#3.5), "lineitem.l_linenumber"(#3.3), "lineitem.l_linestatus"(#3.9), "lineitem.l_orderkey"(#3.0), "lineitem.l_partkey"(#3.1), "lineitem.l_quantity"(#3.4), "lineitem.l_receiptdate"(#3.12), "lineitem.l_returnflag"(#3.8), "lineitem.l_shipdate"(#3.10), "lineitem.l_shipinstruct"(#3.13), "lineitem.l_shipmode"(#3.14), "lineitem.l_suppkey"(#3.2), "lineitem.l_tax"(#3.7) ]
                │   │   │       └── (.cardinality): 0.00
...
└── Project
    ├── .table_index: 9
    ├── .projections: [ "nation.n_name"(#5.1), "__#8.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)"(#8.0) ]
    ├── (.output_columns): [ "__#9.nation"(#9.0), "__#9.revenue"(#9.1) ]
    ├── (.cardinality): 0.00
    └── Aggregate
        ├── .key_table_index: 7
        ...
        ├── .keys: "nation.n_name"(#5.1)
        ├── (.output_columns): [ "__#7.n_name"(#7.0), "__#8.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)"(#8.0) ]
        ├── (.cardinality): 0.00
        └── Join
            ├── .join_type: Inner
            ├── .implementation: None
            ...
            │   │   │   │   │   ├── .table_index: 1
            │   │   │   │   │   ├── .implementation: None
            │   │   │   │   │   ├── (.output_columns): [ "customer.c_custkey"(#1.0), "customer.c_nationkey"(#1.3) ]
            │   │   │   │   │   └── (.cardinality): 0.00
            │   │   │   │   └── Select
            │   │   │   │       ├── .predicate: ("orders.o_orderdate"(#2.4) >= 2023-01-01::date32) AND ("orders.o_orderdate"(#2.4) < 2024-01-01::date32)
            ...
            │   │       ├── .table_index: 4
            │   │       ├── .implementation: None
            │   │       ├── (.output_columns): [ "supplier.s_nationkey"(#4.3), "supplier.s_suppkey"(#4.0) ]
            │   │       └── (.cardinality): 0.00
            │   └── Get
            │       ├── .data_source_id: 1
            │       ├── .table_index: 5
            │       ├── .implementation: None
            │       ├── (.output_columns): [ "nation.n_name"(#5.1), "nation.n_nationkey"(#5.0), "nation.n_regionkey"(#5.2) ]
            │       └── (.cardinality): 0.00
            └── Select
                ├── .predicate: "region.r_name"(#6.1) = 'Asia'::utf8_view
