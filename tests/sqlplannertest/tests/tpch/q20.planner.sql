...
OrderBy { ordering_exprs: [ s_name(#16.0) ASC ], (.output_columns): s_address(#16.1), s_name(#16.0), (.cardinality): 0.00 }
└── Project { .table_index: 16, .projections: [ s_name(#1.1), s_address(#1.2) ], (.output_columns): s_address(#16.1), s_name(#16.0), (.cardinality): 0.00 }
    └── Join { .join_type: LeftSemi, .implementation: None, .join_cond: (s_suppkey(#1.0) = ps_suppkey(#15.0)), (.output_columns): n_comment(#2.3), n_name(#2.1), n_nationkey(#2.0), n_regionkey(#2.2), s_acctbal(#1.5), s_address(#1.2), s_comment(#1.6), s_name(#1.1), s_nationkey(#1.3), s_phone(#1.4), s_suppkey(#1.0), (.cardinality): 0.00 }
        ...
        └── Remap { .table_index: 15, (.output_columns): ps_suppkey(#15.0), (.cardinality): 0.00 }
            └── Project { .table_index: 14, .projections: [ ps_suppkey(#13.1) ], (.output_columns): ps_suppkey(#14.0), (.cardinality): 0.00 }
                └── Project { .table_index: 13, .projections: [ ps_partkey(#12.0), ps_suppkey(#12.1), ps_availqty(#12.2), ps_supplycost(#12.3), ps_comment(#12.4) ], (.output_columns): ps_availqty(#13.2), ps_comment(#13.4), ps_partkey(#13.0), ps_suppkey(#13.1), ps_supplycost(#13.3), (.cardinality): 0.00 }
                    └── Project
                        ├── .table_index: 12
                        ├── .projections: [ ps_partkey(#3.0), ps_suppkey(#3.1), ps_availqty(#3.2), ps_supplycost(#3.3), ps_comment(#3.4), Float64(0.5) * sum(lineitem.l_quantity)(#11.0), l_partkey(#11.1), l_suppkey(#11.2), __always_true(#11.3) ]
                        ├── (.output_columns): Float64(0.5) * sum(lineitem.l_quantity)(#12.5), __always_true(#12.8), l_partkey(#12.6), l_suppkey(#12.7), ps_availqty(#12.2), ps_comment(#12.4), ps_partkey(#12.0), ps_suppkey(#12.1), ps_supplycost(#12.3)
                        ├── (.cardinality): 0.00
                        └── Join
                            ├── .join_type: Inner
                            ├── .implementation: None
                            ├── .join_cond: (ps_partkey(#3.0) = l_partkey(#11.1)) AND (ps_suppkey(#3.1) = l_suppkey(#11.2)) AND (CAST (ps_availqty(#3.2) AS Float64) > Float64(0.5) * sum(lineitem.l_quantity)(#11.0))
                            ├── (.output_columns): Float64(0.5) * sum(lineitem.l_quantity)(#11.0), __always_true(#11.3), l_partkey(#11.1), l_suppkey(#11.2), ps_availqty(#3.2), ps_comment(#3.4), ps_partkey(#3.0), ps_suppkey(#3.1), ps_supplycost(#3.3)
                            ├── (.cardinality): 0.00
                            ...
                            └── Remap { .table_index: 11, (.output_columns): Float64(0.5) * sum(lineitem.l_quantity)(#11.0), __always_true(#11.3), l_partkey(#11.1), l_suppkey(#11.2), (.cardinality): 0.00 }
                                └── Project { .table_index: 10, .projections: [ 0.5::float64 * CAST (sum(lineitem.l_quantity)(#9.3) AS Float64), l_partkey(#9.0), l_suppkey(#9.1), __always_true(#9.2) ], (.output_columns): Float64(0.5) * sum(lineitem.l_quantity)(#10.0), __always_true(#10.3), l_partkey(#10.1), l_suppkey(#10.2), (.cardinality): 0.00 }
                                    └── Project { .table_index: 9, .projections: [ l_partkey(#7.1), l_suppkey(#7.2), true::boolean, sum(lineitem.l_quantity)(#8.0) ], (.output_columns): __always_true(#9.2), l_partkey(#9.0), l_suppkey(#9.1), sum(lineitem.l_quantity)(#9.3), (.cardinality): 0.00 }
                                        └── Aggregate { .aggregate_table_index: 8, .implementation: None, .exprs: sum(l_quantity(#7.4)), .keys: [ l_partkey(#7.1), l_suppkey(#7.2) ], (.output_columns): l_partkey(#7.1), l_suppkey(#7.2), sum(lineitem.l_quantity)(#8.0), (.cardinality): 0.00 }
                                            └── Select
...
EnforcerSort { tuple_ordering: [(#16.0, Asc)], (.output_columns): s_address(#16.1), s_name(#16.0), (.cardinality): 0.00 }
└── Project { .table_index: 16, .projections: [ s_name(#1.1), s_address(#1.2) ], (.output_columns): s_address(#16.1), s_name(#16.0), (.cardinality): 0.00 }
    └── Join
        ├── .join_type: LeftSemi
        ├── .implementation: None
        ├── .join_cond: s_suppkey(#1.0) = ps_suppkey(#15.0)
        ...
        └── Remap { .table_index: 15, (.output_columns): ps_suppkey(#15.0), (.cardinality): 0.00 }
            └── Project { .table_index: 14, .projections: [ ps_suppkey(#3.1) ], (.output_columns): ps_suppkey(#14.0), (.cardinality): 0.00 }
                └── Join
                    ├── .join_type: Inner
                    ├── .implementation: None
                    ├── .join_cond: (ps_partkey(#3.0) = l_partkey(#11.1)) AND (ps_suppkey(#3.1) = l_suppkey(#11.2)) AND (CAST (ps_availqty(#3.2) AS Float64) > Float64(0.5) * sum(lineitem.l_quantity)(#11.0))
                    ├── (.output_columns): Float64(0.5) * sum(lineitem.l_quantity)(#11.0), __always_true(#11.3), l_partkey(#11.1), l_suppkey(#11.2), ps_availqty(#3.2), ps_partkey(#3.0), ps_suppkey(#3.1)
                    ├── (.cardinality): 0.00
                    ├── Join
                    │   ├── .join_type: LeftSemi
                    │   ├── .implementation: None
                    ...
                    └── Remap { .table_index: 11, (.output_columns): Float64(0.5) * sum(lineitem.l_quantity)(#11.0), __always_true(#11.3), l_partkey(#11.1), l_suppkey(#11.2), (.cardinality): 0.00 }
                        └── Project
                            ├── .table_index: 10
                            ├── .projections: [ 0.5::float64 * CAST (sum(lineitem.l_quantity)(#8.0) AS Float64), l_partkey(#7.1), l_suppkey(#7.2), true::boolean ]
                            ├── (.output_columns): Float64(0.5) * sum(lineitem.l_quantity)(#10.0), __always_true(#10.3), l_partkey(#10.1), l_suppkey(#10.2)
                            ├── (.cardinality): 0.00
                            └── Aggregate
                                ...
                                ├── (.output_columns): l_partkey(#7.1), l_suppkey(#7.2), sum(lineitem.l_quantity)(#8.0)
                                ├── (.cardinality): 0.00
                                └── Select
                                    ├── .predicate: (l_shipdate(#7.10) >= 1996-01-01::date32) AND (l_shipdate(#7.10) < 1997-01-01::date32)
