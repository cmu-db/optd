...
Limit { .skip: 0::bigint, .fetch: 100::bigint, (.output_columns): numwait(#15.1), s_name(#15.0), (.cardinality): 0.20 }
└── OrderBy { ordering_exprs: [ numwait(#15.1) DESC, s_name(#15.0) ASC ], (.output_columns): numwait(#15.1), s_name(#15.0), (.cardinality): 0.20 }
    └── Project { .table_index: 15, .projections: [ s_name(#1.1), count(Int64(1))(#14.0) ], (.output_columns): numwait(#15.1), s_name(#15.0), (.cardinality): 0.20 }
        └── Aggregate { .aggregate_table_index: 14, .implementation: None, .exprs: [ count(1::bigint) ], .keys: [ s_name(#1.1) ], (.output_columns): count(Int64(1))(#14.0), s_name(#1.1), (.cardinality): 0.20 }
            └── Join
                ├── .join_type: LeftAnti
                ├── .implementation: None
...
Limit { .skip: 0::bigint, .fetch: 100::bigint, (.output_columns): numwait(#15.1), s_name(#15.0), (.cardinality): 0.20 }
└── EnforcerSort { tuple_ordering: [(#15.1, Desc), (#15.0, Asc)], (.output_columns): numwait(#15.1), s_name(#15.0), (.cardinality): 0.20 }
    └── Project { .table_index: 15, .projections: [ s_name(#1.1), count(Int64(1))(#14.0) ], (.output_columns): numwait(#15.1), s_name(#15.0), (.cardinality): 0.20 }
        └── Aggregate { .aggregate_table_index: 14, .implementation: None, .exprs: [ count(1::bigint) ], .keys: [ s_name(#1.1) ], (.output_columns): count(Int64(1))(#14.0), s_name(#1.1), (.cardinality): 0.20 }
            └── Join
                ├── .join_type: LeftAnti
