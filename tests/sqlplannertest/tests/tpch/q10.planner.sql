...
Limit { .skip: 0::bigint, .fetch: 20::bigint, (.output_columns): __internal_#6.c_acctbal(#6.3), __internal_#6.c_address(#6.5), __internal_#6.c_comment(#6.7), __internal_#6.c_custkey(#6.0), __internal_#6.c_name(#6.1), __internal_#6.c_phone(#6.6), __internal_#6.n_name(#6.4), __internal_#6.revenue(#6.2), (.cardinality): 0.00 }
└── OrderBy { ordering_exprs: [ __internal_#6.revenue(#6.2) DESC ], (.output_columns): __internal_#6.c_acctbal(#6.3), __internal_#6.c_address(#6.5), __internal_#6.c_comment(#6.7), __internal_#6.c_custkey(#6.0), __internal_#6.c_name(#6.1), __internal_#6.c_phone(#6.6), __internal_#6.n_name(#6.4), __internal_#6.revenue(#6.2), (.cardinality): 0.00 }
    └── Project { .table_index: 6, .projections: [ customer.c_custkey(#1.0), customer.c_name(#1.1), __internal_#5.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#5.0), customer.c_acctbal(#1.5), nation.n_name(#4.1), customer.c_address(#1.2), customer.c_phone(#1.4), customer.c_comment(#1.7) ], (.output_columns): __internal_#6.c_acctbal(#6.3), __internal_#6.c_address(#6.5), __internal_#6.c_comment(#6.7), __internal_#6.c_custkey(#6.0), __internal_#6.c_name(#6.1), __internal_#6.c_phone(#6.6), __internal_#6.n_name(#6.4), __internal_#6.revenue(#6.2), (.cardinality): 0.00 }
        └── Aggregate { .aggregate_table_index: 5, .implementation: None, .exprs: sum(lineitem.l_extendedprice(#3.5) * 1::decimal128(20, 0) - lineitem.l_discount(#3.6)), .keys: [ customer.c_custkey(#1.0), customer.c_name(#1.1), customer.c_acctbal(#1.5), customer.c_phone(#1.4), nation.n_name(#4.1), customer.c_address(#1.2), customer.c_comment(#1.7) ], (.output_columns): __internal_#5.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#5.0), customer.c_acctbal(#1.5), customer.c_address(#1.2), customer.c_comment(#1.7), customer.c_custkey(#1.0), customer.c_name(#1.1), customer.c_phone(#1.4), nation.n_name(#4.1), (.cardinality): 0.00 }
            └── Join
                ├── .join_type: Inner
                ├── .implementation: None
...
Limit { .skip: 0::bigint, .fetch: 20::bigint, (.output_columns): __internal_#6.c_acctbal(#6.3), __internal_#6.c_address(#6.5), __internal_#6.c_comment(#6.7), __internal_#6.c_custkey(#6.0), __internal_#6.c_name(#6.1), __internal_#6.c_phone(#6.6), __internal_#6.n_name(#6.4), __internal_#6.revenue(#6.2), (.cardinality): 0.00 }
└── EnforcerSort { tuple_ordering: [(#6.2, Desc)], (.output_columns): __internal_#6.c_acctbal(#6.3), __internal_#6.c_address(#6.5), __internal_#6.c_comment(#6.7), __internal_#6.c_custkey(#6.0), __internal_#6.c_name(#6.1), __internal_#6.c_phone(#6.6), __internal_#6.n_name(#6.4), __internal_#6.revenue(#6.2), (.cardinality): 0.00 }
    └── Project
        ├── .table_index: 6
        ├── .projections: [ customer.c_custkey(#1.0), customer.c_name(#1.1), __internal_#5.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#5.0), customer.c_acctbal(#1.5), nation.n_name(#4.1), customer.c_address(#1.2), customer.c_phone(#1.4), customer.c_comment(#1.7) ]
        ├── (.output_columns): __internal_#6.c_acctbal(#6.3), __internal_#6.c_address(#6.5), __internal_#6.c_comment(#6.7), __internal_#6.c_custkey(#6.0), __internal_#6.c_name(#6.1), __internal_#6.c_phone(#6.6), __internal_#6.n_name(#6.4), __internal_#6.revenue(#6.2)
        ├── (.cardinality): 0.00
        └── Aggregate
            ...
            ├── (.output_columns): __internal_#5.sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#5.0), customer.c_acctbal(#1.5), customer.c_address(#1.2), customer.c_comment(#1.7), customer.c_custkey(#1.0), customer.c_name(#1.1), customer.c_phone(#1.4), nation.n_name(#4.1)
            ├── (.cardinality): 0.00
            └── Join
                ├── .join_type: Inner
                ├── .implementation: None
