...
OrderBy { ordering_exprs: [ custdist(#8.1) DESC, c_count(#8.0) DESC ], (.output_columns): c_count(#8.0), custdist(#8.1), (.cardinality): 0.20 }
└── Project { .table_index: 8, .projections: [ c_count(#6.1), count(Int64(1))(#7.0) ], (.output_columns): c_count(#8.0), custdist(#8.1), (.cardinality): 0.20 }
    └── Aggregate { .aggregate_table_index: 7, .implementation: None, .exprs: [ count(1::bigint) ], .keys: [ c_count(#6.1) ], (.output_columns): c_count(#6.1), count(Int64(1))(#7.0), (.cardinality): 0.20 }
        └── Remap { .table_index: 6, (.output_columns): c_count(#6.1), c_custkey(#6.0), (.cardinality): 0.20 }
            └── Project { .table_index: 5, .projections: [ c_custkey(#4.0), count(orders.o_orderkey)(#4.1) ], (.output_columns): c_count(#5.1), c_custkey(#5.0), (.cardinality): 0.20 }
...
EnforcerSort { tuple_ordering: [(#8.1, Desc), (#8.0, Desc)], (.output_columns): c_count(#8.0), custdist(#8.1), (.cardinality): 0.20 }
└── Project { .table_index: 8, .projections: [ c_count(#6.1), count(Int64(1))(#7.0) ], (.output_columns): c_count(#8.0), custdist(#8.1), (.cardinality): 0.20 }
    └── Aggregate { .aggregate_table_index: 7, .implementation: None, .exprs: [ count(1::bigint) ], .keys: [ c_count(#6.1) ], (.output_columns): c_count(#6.1), count(Int64(1))(#7.0), (.cardinality): 0.20 }
        └── Remap { .table_index: 6, (.output_columns): c_count(#6.1), c_custkey(#6.0), (.cardinality): 0.20 }
            └── Project { .table_index: 5, .projections: [ c_custkey(#4.0), count(orders.o_orderkey)(#4.1) ], (.output_columns): c_count(#5.1), c_custkey(#5.0), (.cardinality): 0.20 }
