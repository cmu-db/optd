...
└── Project { .table_index: 16, .projections: [ s_suppkey(#15.0), s_name(#15.1), s_address(#15.2), s_phone(#15.4), total_revenue(#15.8) ], (.output_columns): s_address(#16.2), s_name(#16.1), s_phone(#16.3), s_suppkey(#16.0), total_revenue(#16.4), (.cardinality): 0.00 }
    └── Project
        ...
        └── Join { .join_type: Inner, .implementation: None, .join_cond: (total_revenue(#6.1) = max(revenue0.total_revenue)(#14.0)), (.output_columns): max(revenue0.total_revenue)(#14.0), s_acctbal(#1.5), s_address(#1.2), s_comment(#1.6), s_name(#1.1), s_nationkey(#1.3), s_phone(#1.4), s_suppkey(#1.0), supplier_no(#6.0), total_revenue(#6.1), (.cardinality): 0.00 }
            ...
            │   └── Remap { .table_index: 6, (.output_columns): supplier_no(#6.0), total_revenue(#6.1), (.cardinality): 0.20 }
            │       └── Project { .table_index: 5, .projections: [ l_suppkey(#4.0), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#4.1) ], (.output_columns): supplier_no(#5.0), total_revenue(#5.1), (.cardinality): 0.20 }
            │           └── Project { .table_index: 4, .projections: [ l_suppkey(#2.2), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#3.0) ], (.output_columns): l_suppkey(#4.0), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#4.1), (.cardinality): 0.20 }
            │               └── Aggregate { .aggregate_table_index: 3, .implementation: None, .exprs: sum(l_extendedprice(#2.5) * 1::decimal128(20, 0) - l_discount(#2.6)), .keys: [ l_suppkey(#2.2) ], (.output_columns): l_suppkey(#2.2), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#3.0), (.cardinality): 0.20 }
            │                   └── Select
            ...
            └── Remap { .table_index: 14, (.output_columns): max(revenue0.total_revenue)(#14.0), (.cardinality): 1.00 }
                └── Project { .table_index: 13, .projections: max(revenue0.total_revenue)(#12.0), (.output_columns): max(revenue0.total_revenue)(#13.0), (.cardinality): 1.00 }
                    └── Aggregate { .aggregate_table_index: 12, .implementation: None, .exprs: [ max(total_revenue(#11.1)) ], .keys: [], (.output_columns): max(revenue0.total_revenue)(#12.0), (.cardinality): 1.00 }
                        └── Remap { .table_index: 11, (.output_columns): supplier_no(#11.0), total_revenue(#11.1), (.cardinality): 0.20 }
                            └── Project { .table_index: 10, .projections: [ l_suppkey(#9.0), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#9.1) ], (.output_columns): supplier_no(#10.0), total_revenue(#10.1), (.cardinality): 0.20 }
                                └── Project { .table_index: 9, .projections: [ l_suppkey(#7.2), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#8.0) ], (.output_columns): l_suppkey(#9.0), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#9.1), (.cardinality): 0.20 }
                                    └── Aggregate { .aggregate_table_index: 8, .implementation: None, .exprs: sum(l_extendedprice(#7.5) * 1::decimal128(20, 0) - l_discount(#7.6)), .keys: [ l_suppkey(#7.2) ], (.output_columns): l_suppkey(#7.2), sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)(#8.0), (.cardinality): 0.20 }
                                        └── Select
...
EnforcerSort { tuple_ordering: [(#16.0, Asc)], (.output_columns): s_address(#16.2), s_name(#16.1), s_phone(#16.3), s_suppkey(#16.0), total_revenue(#16.4), (.cardinality): 0.00 }
└── Project { .table_index: 16, .projections: [ s_suppkey(#15.0), s_name(#15.1), s_address(#15.2), s_phone(#15.4), total_revenue(#15.8) ], (.output_columns): s_address(#16.2), s_name(#16.1), s_phone(#16.3), s_suppkey(#16.0), total_revenue(#16.4), (.cardinality): 0.00 }
    └── Project
        ├── .table_index: 15
        ├── .projections: [ s_suppkey(#1.0), s_name(#1.1), s_address(#1.2), s_nationkey(#1.3), s_phone(#1.4), s_acctbal(#1.5), s_comment(#1.6), supplier_no(#6.0), total_revenue(#6.1) ]
