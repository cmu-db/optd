...
OrderBy { ordering_exprs: [ l_shipmode(#4.0) ASC ], (.output_columns): high_priority_orders(#4.1), l_shipmode(#4.0), low_priority_orders(#4.2), (.cardinality): 0.20 }
└── Project { .table_index: 4, .projections: [ l_shipmode(#2.14), sum(CASE WHEN orders.o_orderpriority = Utf8("1-URGENT") OR orders.o_orderpriority = Utf8("2-HIGH") THEN Int64(1) ELSE Int64(0) END)(#3.0), sum(CASE WHEN orders.o_orderpriority != Utf8("1-URGENT") AND orders.o_orderpriority != Utf8("2-HIGH") THEN Int64(1) ELSE Int64(0) END)(#3.1) ], (.output_columns): high_priority_orders(#4.1), l_shipmode(#4.0), low_priority_orders(#4.2), (.cardinality): 0.20 }
    └── Aggregate
...
EnforcerSort { tuple_ordering: [(#4.0, Asc)], (.output_columns): high_priority_orders(#4.1), l_shipmode(#4.0), low_priority_orders(#4.2), (.cardinality): 0.20 }
└── Project { .table_index: 4, .projections: [ l_shipmode(#2.14), sum(CASE WHEN orders.o_orderpriority = Utf8("1-URGENT") OR orders.o_orderpriority = Utf8("2-HIGH") THEN Int64(1) ELSE Int64(0) END)(#3.0), sum(CASE WHEN orders.o_orderpriority != Utf8("1-URGENT") AND orders.o_orderpriority != Utf8("2-HIGH") THEN Int64(1) ELSE Int64(0) END)(#3.1) ], (.output_columns): high_priority_orders(#4.1), l_shipmode(#4.0), low_priority_orders(#4.2), (.cardinality): 0.20 }
    └── Aggregate
        ├── .aggregate_table_index: 3
        ├── .implementation: None
