...
└── Aggregate { .key_table_index: 3, .aggregate_table_index: 4, .implementation: None, .exprs: sum(`lineitem`.`l_extendedprice`(#1.5) * 1::decimal128(20, 0) - `lineitem`.`l_discount`(#1.6)), .keys: [], (.output_columns): `__internal_#4`.`sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)`(#4.0), (.cardinality): 1.00 }
    └── Join
        ...
        ├── (.cardinality): 0.00
        ├── Select
        │   ├── .predicate: (((`lineitem`.`l_quantity`(#1.4) >= 100::decimal128(15, 2)) AND (`lineitem`.`l_quantity`(#1.4) <= 1100::decimal128(15, 2))) OR ((`lineitem`.`l_quantity`(#1.4) >= 1000::decimal128(15, 2)) AND (`lineitem`.`l_quantity`(#1.4) <= 2000::decimal128(15, 2))) OR ((`lineitem`.`l_quantity`(#1.4) >= 2000::decimal128(15, 2)) AND (`lineitem`.`l_quantity`(#1.4) <= 3000::decimal128(15, 2)))) AND ((`lineitem`.`l_shipmode`(#1.14) = AIR::utf8_view) OR (`lineitem`.`l_shipmode`(#1.14) = AIR REG::utf8_view)) AND (`lineitem`.`l_shipinstruct`(#1.13) = DELIVER IN PERSON::utf8_view)
        ...
        └── Select { .predicate: (((`part`.`p_brand`(#2.3) = Brand#12::utf8_view) AND (`part`.`p_container`(#2.6) IN [SM CASE::utf8_view, SM BOX::utf8_view, SM PACK::utf8_view, SM PKG::utf8_view]) AND (`part`.`p_size`(#2.5) <= 5::integer)) OR ((`part`.`p_brand`(#2.3) = Brand#23::utf8_view) AND (`part`.`p_container`(#2.6) IN [MED BAG::utf8_view, MED BOX::utf8_view, MED PKG::utf8_view, MED PACK::utf8_view]) AND (`part`.`p_size`(#2.5) <= 10::integer)) OR ((`part`.`p_brand`(#2.3) = Brand#34::utf8_view) AND (`part`.`p_container`(#2.6) IN [LG CASE::utf8_view, LG BOX::utf8_view, LG PACK::utf8_view, LG PKG::utf8_view]) AND (`part`.`p_size`(#2.5) <= 15::integer))) AND (`part`.`p_size`(#2.5) >= 1::integer), (.output_columns): `part`.`p_brand`(#2.3), `part`.`p_comment`(#2.8), `part`.`p_container`(#2.6), `part`.`p_mfgr`(#2.2), `part`.`p_name`(#2.1), `part`.`p_partkey`(#2.0), `part`.`p_retailprice`(#2.7), `part`.`p_size`(#2.5), `part`.`p_type`(#2.4), (.cardinality): 0.00 }
...
└── Aggregate { .key_table_index: 3, .aggregate_table_index: 4, .implementation: None, .exprs: sum(`lineitem`.`l_extendedprice`(#1.5) * 1::decimal128(20, 0) - `lineitem`.`l_discount`(#1.6)), .keys: [], (.output_columns): `__internal_#4`.`sum(lineitem.l_extendedprice * Int64(1) - lineitem.l_discount)`(#4.0), (.cardinality): 1.00 }
    └── Join
        ...
        └── Select { .predicate: (((`part`.`p_brand`(#2.3) = Brand#12::utf8_view) AND (`part`.`p_container`(#2.6) IN [SM CASE::utf8_view, SM BOX::utf8_view, SM PACK::utf8_view, SM PKG::utf8_view]) AND (`part`.`p_size`(#2.5) <= 5::integer)) OR ((`part`.`p_brand`(#2.3) = Brand#23::utf8_view) AND (`part`.`p_container`(#2.6) IN [MED BAG::utf8_view, MED BOX::utf8_view, MED PKG::utf8_view, MED PACK::utf8_view]) AND (`part`.`p_size`(#2.5) <= 10::integer)) OR ((`part`.`p_brand`(#2.3) = Brand#34::utf8_view) AND (`part`.`p_container`(#2.6) IN [LG CASE::utf8_view, LG BOX::utf8_view, LG PACK::utf8_view, LG PKG::utf8_view]) AND (`part`.`p_size`(#2.5) <= 15::integer))) AND (`part`.`p_size`(#2.5) >= 1::integer), (.output_columns): `part`.`p_brand`(#2.3), `part`.`p_container`(#2.6), `part`.`p_partkey`(#2.0), `part`.`p_size`(#2.5), (.cardinality): 0.00 }
