...
//! Implementation of the HyperLogLog++ data structure as described in
//! Stefan Heule et al. paper:
//! "HyperLogLog in Practice: Algorithmic Engineering of a State of The Art
//!  Cardinality Estimation Algorithm" (2013).
//! For more details, refer to:
//! https://static.googleusercontent.com/media/research.google.com/en//pubs/archive/40671.pdf

// The HyperLogLog structure to provide a statistical estimate of NDistinct.
