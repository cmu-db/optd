...
pub trait TransformationRule {
    ...
    /// Adds a new expression (ideally generated by the [`apply`] function) to the memo table.
    ///
    /// TODO Should this function live in the rule implementation or on the memo table itself?
    async fn update_memo(&self, expr: Expr, memo: &mut Memo);
}
