...
CREATE EXTERNAL TABLE customer_tbl STORED AS CSV DELIMITER '|' LOCATION 'optd-perftest/src/tpch/customer.tbl';
insert into customer select column_1, column_2, column_3, column_4, column_5, column_6, column_7, column_8 from customer_tbl;
CREATE EXTERNAL TABLE lineitem_tbl STORED AS CSV DELIMITER '|' LOCATION 'optd-perftest/src/tpch/lineitem.tbl';
...
CREATE EXTERNAL TABLE nation_tbl STORED AS CSV DELIMITER '|' LOCATION 'optd-perftest/src/tpch/nation.tbl';
insert into nation select column_1, column_2, column_3, column_4 from nation_tbl;
CREATE EXTERNAL TABLE orders_tbl STORED AS CSV DELIMITER '|' LOCATION 'optd-perftest/src/tpch/orders.tbl';
...
CREATE EXTERNAL TABLE part_tbl STORED AS CSV DELIMITER '|' LOCATION 'optd-perftest/src/tpch/part.tbl';
insert into part select column_1, column_2, column_3, column_4, column_5, column_6, column_7, column_8, column_9 from part_tbl;
CREATE EXTERNAL TABLE partsupp_tbl STORED AS CSV DELIMITER '|' LOCATION 'optd-perftest/src/tpch/partsupp.tbl';
insert into partsupp select column_1, column_2, column_3, column_4, column_5 from partsupp_tbl;
CREATE EXTERNAL TABLE region_tbl STORED AS CSV DELIMITER '|' LOCATION 'optd-perftest/src/tpch/region.tbl';
insert into region select column_1, column_2, column_3 from region_tbl;
CREATE EXTERNAL TABLE supplier_tbl STORED AS CSV DELIMITER '|' LOCATION 'optd-perftest/src/tpch/supplier.tbl';
